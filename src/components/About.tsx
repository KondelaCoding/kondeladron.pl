...
const About = () => {
  ...
  return (
    <div id="about" className="flex justify-center gap-20 mt-40 mx-auto xl:max-w-[1200px]">
      <div>
        <div
          ref={ref1}
      ...
      <div className="hidden flex-grow-0 justify-center flex-col gap-20 items-start mt-10 xl:flex">
        <Image
          src={AboutDesktop}
          alt="about-desktop"
          width={600}
